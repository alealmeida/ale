...
const urlBuilder = src => {
  const fullUrl = configs_namespaceObject.M + src;
  return fullUrl;
};
...
const Hero = external_styled_components_default().header.withConfig({
  displayName: "slug__Hero",
  componentId: "sc-6ssb0y-0"
})(["width:100vw;height:100%;display:flex;background:var(--color-", "-dark);justify-content:center;"], ({
  brand,
  color
}) => getBackground(color, brand)); // PAGE
